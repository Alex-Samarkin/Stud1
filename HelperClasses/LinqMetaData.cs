...
namespace Stud1.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		{
			switch((Stud1.EntityType)typeOfEntity)
			{
		...
		/// <summary>returns the datasource to use in a Linq query when targeting ParamEntity instances in the database.</summary>
		public DataSource2<ParamEntity> Param {	get { return new DataSource2<ParamEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
