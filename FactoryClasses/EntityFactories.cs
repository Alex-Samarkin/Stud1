...
namespace Stud1.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, Stud1.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((Stud1.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public AddressEntityFactory() : base("AddressEntity", Stud1.EntityType.AddressEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new AddressEntity(fields); }
	}

	/// <summary>Factory to create new, empty ParamEntity objects.</summary>
	[Serializable]
	public partial class ParamEntityFactory : EntityFactoryBase2<ParamEntity> 
	{
		/// <summary>CTor</summary>
		public ParamEntityFactory() : base("ParamEntity", Stud1.EntityType.ParamEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new ParamEntity(fields); }
	}
	...
	{
		/// <summary>CTor</summary>
		public PersonEntityFactory() : base("PersonEntity", Stud1.EntityType.PersonEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(Stud1.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(Stud1.EntityType)))
			{
				var factory = GetFactory((Stud1.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the Stud1.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(Stud1.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case Stud1.EntityType.AddressEntity:
					return new AddressEntityFactory();
				case Stud1.EntityType.ParamEntity:
					return new ParamEntityFactory();
				case Stud1.EntityType.PersonEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the Stud1.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (Stud1.EntityType)Enum.Parse(typeof(Stud1.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((Stud1.EntityType)Enum.Parse(typeof(Stud1.EntityType), leftOperandEntityName, false), joinType, (Stud1.EntityType)Enum.Parse(typeof(Stud1.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (Stud1.EntityType)Enum.Parse(typeof(Stud1.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((Stud1.EntityType)entityTypeValue); }
